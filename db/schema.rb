...
ActiveRecord::Schema.define(version: 20140528160923) do
  ...
  create_table "providers", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.decimal  "wait_general"
    t.decimal  "wait_pediatrician"
    t.decimal  "wait_gynecologist"
    t.decimal  "wait_surgery"
